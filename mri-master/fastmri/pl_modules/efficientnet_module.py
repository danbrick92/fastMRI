...
class EfficientNetModule(MriModule):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(out_chans)
        self.efficient_net = EffUNet(model='b3', pretrained=False, out_channels=self.out_chans,device='cuda',freeze_backbone=True)

    def forward(self, image):
        return self.efficient_net(image.unsqueeze(1)).squeeze(1)
