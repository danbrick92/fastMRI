...
from fastmri.pl_modules import FastMriDataModule, UnetModule, EfficientNetModule
...
def build_args():
    ...
    default_root_dir = fetch_dir("log_path", path_config) / "unet" / "efficientnetb3"
    ...
    # module config
    parser = EfficientNetModule.add_model_specific_args(parser)
    parser.set_defaults(
    ...
    parser.set_defaults(
        ...
        max_epochs=50,  # max number of epochs #50
    )
