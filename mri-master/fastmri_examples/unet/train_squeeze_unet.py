...
from fastmri.pl_modules import SqueezeUnetModule
...
def build_args():
    ...
    default_root_dir = fetch_dir("log_path", path_config) / "squeeze_unet" / "squeeze_unet_demo"
    ...
    # module config
    parser = SqueezeUnetModule.add_model_specific_args(parser)
    parser.set_defaults(
